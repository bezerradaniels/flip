...
export const demoProducts = [
  {
    ...
    category: { id: 'personalizados', name: 'Personalizados', slug: 'personalizados' }, brand: 'Flip', unit: 'Unidade', condition: 'Sob encomenda', is_featured: true, is_active: true,
  ...
  },
  {
    ...
    category: { id: 'corporativo', name: 'Brindes corporativos', slug: 'brindes-corporativos' }, brand: 'Flip', unit: 'Kit', condition: 'Sob encomenda', is_featured: true, is_active: true,
  ...
  },
  {
    ...
    category: { id: 'mdf', name: 'MDF e sinalização', slug: 'mdf-e-sinalizacao' }, brand: 'Flip', unit: 'Unidade', condition: 'Sob encomenda', is_featured: true, is_active: true,
  ...
  },
  {
    ...
    category: { id: 'festas', name: 'Festas e lembranças', slug: 'festas-e-lembrancas' }, brand: 'Flip', unit: 'Unidade', condition: 'Sob encomenda', is_featured: false, is_active: true,
  ...
  },
  {
    ...
    category: { id: 'adesivos', name: 'Adesivos e etiquetas', slug: 'adesivos-e-etiquetas' }, brand: 'Flip', unit: 'Kit', condition: 'Sob encomenda', is_featured: false, is_active: true,
  ...
  },
  {
    ...
    category: { id: 'festas', name: 'Festas e lembranças', slug: 'festas-e-lembrancas' }, brand: 'Flip', unit: 'Kit', condition: 'Sob encomenda', is_featured: false, is_active: true,
  ...
  },
  {
    ...
    category: { id: 'grafica', name: 'Gráfica personalizada', slug: 'grafica-personalizada' }, brand: 'Flip', unit: 'Kit', condition: 'Sob encomenda', is_featured: false, is_active: true,
